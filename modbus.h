...
int modbus_read_bits(modbus_t *ctx, int addr, int nb, uint8_t *dest);//01
int modbus_read_input_bits(modbus_t *ctx, int addr, int nb, uint8_t *dest);//02
int modbus_read_registers(modbus_t *ctx, int addr, int nb, uint16_t *dest);//03
int modbus_read_input_registers(modbus_t *ctx, int addr, int nb, uint16_t *dest);//04
